...
var Safe = function(code, key) {
	var secret = code
	var storekey = key
	this.unlock = function(sameKey) {
			if (sameKey === storekey) {
			return secret
		}
		return "can't get in"
...
var Validator = function() {
	this.email = function(string) {
		...
		var ironyard = string.slice((stringCount - 16), stringCount)
		// console.log(ironyard)
		if (ironyard === "@theironyard.com") {
			return true
		}
		return false
	}
...
if (typeof Validator === "function") {
  ...
  // console.log(valid.email("name@theironyard.com"))
